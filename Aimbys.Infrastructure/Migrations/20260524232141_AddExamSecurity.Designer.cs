...
namespace Aimbys.Infrastructure.Migrations
{
    ...
    [Migration("20260524232141_AddExamSecurity")]
    partial class AddExamSecurity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.Exam", b =>
                {
                    ...
                    b.HasIndex("InstituteId")
                        .HasDatabaseName("IX_Exams_InstituteId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamAttempt", b =>
                {
                    ...
                    b.HasIndex("ExamId", "StudentUserId")
                        .HasDatabaseName("IX_ExamAttempts_ExamId_StudentUserId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamEvent", b =>
                {
                    ...
                    b.HasIndex("AttemptId", "OccurredAtUtc")
                        .HasDatabaseName("IX_ExamEvents_AttemptId_OccurredAtUtc");

                    b.ToTable("ExamEvents", (string)null);
                });

            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamSecurityProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("BlockKeyboardShortcuts")
                        .HasColumnType("bit");

                    b.Property<bool>("DetectResize")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("MaxConnectionLossSeconds")
                        .HasColumnType("int");

                    b.Property<bool>("RequireFullscreen")
                        .HasColumnType("bit");

                    b.Property<bool>("TrackDevice")
                        .HasColumnType("bit");

                    b.Property<bool>("TrackSession")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ExamId")
                        .IsUnique()
                        .HasDatabaseName("UX_ExamSecurityProfiles_ExamId");

                    b.ToTable("ExamSecurityProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamSession", b =>
                {
                    ...
                    b.HasIndex("AttemptId")
                        .IsUnique()
                        .HasDatabaseName("UX_ExamSessions_AttemptId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamSecurityProfile", b =>
                {
                    b.HasOne("Aimbys.Domain.Entities.Exams.Exam", "Exam")
                        .WithOne()
                        .HasForeignKey("Aimbys.Domain.Entities.Exams.ExamSecurityProfile", "ExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
