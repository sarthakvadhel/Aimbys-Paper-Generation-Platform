...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Analytics.AggregatedAnalyticsTable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Scope", "ScopeId", "DimensionKey", "PeriodStart")
                        .HasDatabaseName("IX_AggregatedAnalyticsTables_Scope_ScopeId_DimensionKey_PeriodStart");

                    b.ToTable("AggregatedAnalyticsTables", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Analytics.AnalyticsSnapshot", b =>
                {
                    ...
                    b.HasIndex("Scope", "ScopeId", "MetricKey", "CapturedAtUtc")
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Analytics.CachedLeaderboardEntry", b =>
                {
                    ...
                    b.HasIndex("ExamId", "ClassBatchId", "Rank")
                        .HasDatabaseName("IX_CachedLeaderboardEntries_ExamId_ClassBatchId_Rank");

                    b.ToTable("CachedLeaderboardEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.Exam", b =>
                {
                    ...
                    b.HasIndex("ClassBatchId")
                        .HasDatabaseName("IX_Exams_ClassBatchId");

                    b.HasIndex("InstituteId", "Status")
                        .HasDatabaseName("IX_Exams_InstituteId_Status");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamAttempt", b =>
                {
                    ...
                    b.HasIndex("ExamId", "StudentProfileId")
                        .IsUnique()
                        .HasDatabaseName("UX_ExamAttempts_ExamId_StudentProfileId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Exams.ExamAttemptAnswer", b =>
                {
                    ...
                    b.HasIndex("AttemptId", "QuestionId")
                        .IsUnique()
                        .HasDatabaseName("UX_ExamAttemptAnswers_AttemptId_QuestionId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Moderation.ModeratedScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ModeratedScores", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Moderation.Moderation", b =>
                {
                    ...
                    b.HasIndex("ModeratorTeacherProfileId", "Verdict")
                        .HasDatabaseName("IX_Moderations_ModeratorTeacherProfileId_Verdict");

                    b.ToTable("Moderations", (string)null);
                });

            modelBuilder.Entity("Aimbys.Domain.Entities.Moderation.ModerationSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EvaluatorScoresJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ModerationSnapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Results.FinalPublishedScore", b =>
                {
                    ...
                    b.HasIndex("ExamAttemptAnswerId", "Version")
                        .IsUnique()
                        .HasDatabaseName("UX_FinalPublishedScores_ExamAttemptAnswerId_Version");

                    b.ToTable("FinalPublishedScores", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Results.Result", b =>
                {
                    ...
                    b.HasIndex("ExamAttemptId")
                        .IsUnique()
                        .HasDatabaseName("UX_Results_ExamAttemptId");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Results.ResultAppeal", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId")
                        .HasDatabaseName("IX_ResultAppeals_StudentProfileId");

                    b.HasIndex("ExamAttemptAnswerId", "Status")
                        .HasDatabaseName("IX_ResultAppeals_ExamAttemptAnswerId_Status");

                    b.ToTable("ResultAppeals", (string)null);
                });

            modelBuilder.Entity("Aimbys.Domain.Entities.Results.ResultArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ExamId", "ArchiveType")
                        .HasDatabaseName("IX_ResultArchives_ExamId_ArchiveType");

                    b.ToTable("ResultArchives", (string)null);
                });
