...
namespace Aimbys.Infrastructure.Migrations
{
    ...
    [Migration("20260525063040_AddMultilingual")]
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Multilingual.Language", b =>
                {
                    ...
                    b.HasIndex("InstituteId", "Code")
                        .IsUnique()
                        .HasDatabaseName("UX_Languages_InstituteId_Code");
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Multilingual.PaperLanguageSet", b =>
                {
                    ...
                    b.HasIndex("PaperVersionId", "LanguageId")
                        .IsUnique()
                        .HasDatabaseName("UX_PaperLanguageSets_PaperVersionId_LanguageId");

                    b.ToTable("PaperLanguageSets", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Multilingual.QuestionTranslation", b =>
                {
                    ...
                    b.HasIndex("QuestionVersionId", "LanguageId")
                        .IsUnique()
                        .HasDatabaseName("UX_QuestionTranslations_QuestionVersionId_LanguageId");
