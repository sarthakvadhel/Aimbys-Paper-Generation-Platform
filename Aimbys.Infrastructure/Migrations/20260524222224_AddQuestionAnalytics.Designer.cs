...
namespace Aimbys.Infrastructure.Migrations
{
    ...
    [Migration("20260524222224_AddQuestionAnalytics")]
    partial class AddQuestionAnalytics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Questions.QuestionDifficultyAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AuthoredDifficulty")
                        .HasColumnType("int");

                    b.Property<DateTime>("ComputedAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<int>("ComputedDifficulty")
                        .HasColumnType("int");

                    b.Property<double>("ConfidencePercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("float(5)");

                    b.Property<int>("DriftDirection")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuestionId", "ComputedAtUtc")
                        .HasDatabaseName("IX_QuestionDifficultyAudits_QuestionId_ComputedAtUtc");

                    b.ToTable("QuestionDifficultyAudits", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Questions.QuestionExposureLog", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "InstituteId")
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Questions.QuestionUsageAnalytics", b =>
                {
                    ...
                    b.HasIndex("QuestionId", "AcademicYearId")
                        .IsUnique()
                        .HasDatabaseName("UX_QuestionUsageAnalytics_QuestionId_AcademicYearId");

                    b.ToTable("QuestionUsageAnalytics", (string)null);
                });
