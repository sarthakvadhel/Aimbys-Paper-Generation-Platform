...
namespace Aimbys.Infrastructure.Migrations
{
    ...
    [Migration("20260524233603_AddEvaluationDesk")]
    partial class AddEvaluationDesk
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Evaluation.DraftScore", b =>
                {
                    ...
                    b.HasIndex("EvaluationId", "CriterionIndex")
                        .IsUnique()
                        .HasDatabaseName("UX_DraftScores_EvaluationId_CriterionIndex");

                    b.ToTable("DraftScores", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Evaluation.EvaluatedScore", b =>
                {
                    ...
                    b.ToTable("EvaluatedScores", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Evaluation.Evaluation", b =>
                {
                    ...
                    b.HasIndex("EvaluatorTeacherProfileId", "Status")
                        .HasDatabaseName("IX_Evaluations_EvaluatorTeacherProfileId_Status");

                    b.ToTable("Evaluations", (string)null);
                });

            modelBuilder.Entity("Aimbys.Domain.Entities.Evaluation.RubricScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RubricScores", (string)null);
                });
            ...
            modelBuilder.Entity("Aimbys.Domain.Entities.Evaluation.ScoringScheme", b =>
                {
                    ...
                    b.HasIndex("PaperVersionId", "QuestionId")
                        .IsUnique()
